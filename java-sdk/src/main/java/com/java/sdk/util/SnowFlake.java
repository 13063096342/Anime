 ...
 * 如下下面程序IdWorker类的startTime属性）。 41位的时间截，可以使用69年，年T = (1L << 41) /
...
public class SnowFlake {
    ...
    /**
     * 开始时间截 (2017-05-31 14:30:00)
     */
    private final long twepoch = 1496217866185L;
    ...
    public static void main(String[] args) {
        ...
        System.out.println("结束时间戳:" + end + ",花费时间(毫秒)：" + (end - start));
    }
